  ...
  return (
    <div className="mb-6">
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, #2F7DF6 0%, transparent 100%)" }}
      />
    </div>
  );
}
  ...
  return (
    <motion.a
      ...
      whileHover={{
        y: -2,
        color: "#2F7DF6",
        borderColor: "rgba(47,125,246,.45)",
...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: [
          "radial-gradient(ellipse 70% 60% at 12% 20%, rgba(47,125,246,.05) 0%, transparent 55%)",
          "radial-gradient(ellipse 55% 55% at 90% 75%, rgba(25,85,216,.05) 0%, transparent 55%)",
          "#030810",
        ].join(", "),
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 5%, rgba(47,125,246,.5) 35%, rgba(25,85,216,.45) 65%, transparent 95%)",
          filter: "blur(4px)",
        }}
      />
          ...
          <motion.div variants={fadeUp}>
            ...
            <div className="flex flex-col gap-5">
              ...
              <ContactRow
                label="Ubicación"
                value="Paraguay"
                iconBg="rgba(47,125,246,.07)"
                iconBorder="rgba(47,125,246,.18)"
                icon={
