...
export default function WhySection() {
  ...
  return (
    <section
      ...
      style={{
        background: [
          "radial-gradient(ellipse 70% 60% at 90% 50%, rgba(25,85,216,.075) 0%, transparent 60%)",
          "radial-gradient(ellipse 50% 50% at 5%  20%, rgba(47,125,246,.055) 0%, transparent 55%)",
          "#050B14",
        ].join(", "),
      }}
    >
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
          <div className="w-[800px] h-32 rounded-full opacity-30" style={{
            background: "radial-gradient(ellipse, rgba(47,125,246,.08) 0%, transparent 70%)",
          }} />
        </div>
