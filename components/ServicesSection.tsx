  ...
  return (
    <motion.div
      className="group relative h-full rounded-2xl p-7 border border-white/[.07]
        ...
        hover:shadow-[0_0_50px_rgba(47,125,246,.06),inset_0_0_0_1px_rgba(47,125,246,.15)]"
      initial="rest"
      whileHover="hovered"
      variants={{
        rest:    { y: 0 },
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: "linear-gradient(90deg, transparent, #2F7DF6 50%, transparent)" }}
        variants={{
      ...
      <div className="relative w-12 h-12 rounded-xl flex items-center justify-center mb-6 overflow-hidden"
        style={{ background: "linear-gradient(135deg, rgba(47,125,246,.12), rgba(25,85,216,.07))" }}>
        <motion.div
          className="absolute inset-0 rounded-xl"
          style={{ background: "linear-gradient(135deg, rgba(47,125,246,.18), rgba(25,85,216,.12))" }}
      ...
      <div className="absolute -top-3 -right-3 w-16 h-16 opacity-[.04] group-hover:opacity-[.09]
        ...
        <svg viewBox="0 0 100 100" fill="none">
          <polygon points="50,6 88,28 88,72 50,94 12,72 12,28"
            stroke="#2F7DF6" strokeWidth="8" fill="none" />
        </svg>
      </div>
    </motion.div>
  );
...
export default function ServicesSection() {
  ...
  return (
    <section
      ...
      style={{
        background: [
          "radial-gradient(ellipse 75% 55% at 10% 55%, rgba(25,85,216,.08) 0%, transparent 58%)",
          "radial-gradient(ellipse 55% 55% at 92% 15%, rgba(47,125,246,.065) 0%, transparent 55%)",
          "#050B14",
        ].join(", "),
      }}
    >
