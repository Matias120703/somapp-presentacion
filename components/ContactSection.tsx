    ...
    <div>
      ...
      <input
        ...
        style={{
          ...
          border: `1px solid ${focused ? "rgba(47,125,246,.42)" : "rgba(255,255,255,.08)"}`,
          boxShadow: focused ? "0 0 0 3px rgba(47,125,246,.07)" : "none",
        }}
      />
    </div>
  );
    ...
    >
      ...
      <motion.div variants={fadeUp} className="flex items-center gap-3.5 mb-6">
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(47,125,246,.15) 0%, rgba(25,85,216,.1) 100%)",
            border: "1px solid rgba(47,125,246,.32)",
            boxShadow: "0 0 28px rgba(47,125,246,.14), inset 0 1px 0 rgba(47,125,246,.2)",
          }}
        >
      ...
      <motion.div
        variants={fadeUp}
        className="h-px mb-7"
        style={{ background: "linear-gradient(90deg, rgba(47,125,246,.35), rgba(47,125,246,.05) 70%, transparent)" }}
      />
      ...
      <motion.div variants={fadeUp} className="flex flex-col gap-4 mb-10">
        ...
        <motion.div
          ...
          whileHover={{
            borderColor: "rgba(47,125,246,.22)",
            boxShadow: "0 10px 40px rgba(47,125,246,.06)",
            y: -3,
            transition: { duration: 0.22, ease: "easeOut" },
          }}
        >
      ...
      >
        <div
          ...
          style={{ background: "rgba(47,125,246,.1)" }}
        >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, transparent, rgba(47,125,246,.5), transparent)" }}
      />

      {/* Ambient glow top-right */}
      <div
        className="absolute -top-28 -right-28 w-80 h-80 pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(47,125,246,.055) 0%, transparent 65%)" }}
      />
      ...
      <div className="flex items-center gap-3 mb-7">
        <div
          ...
          style={{ background: "rgba(47,125,246,.1)", border: "1px solid rgba(47,125,246,.22)" }}
        >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <motion.button
            ...
            className="btn-primary flex-1 flex items-center justify-center gap-2.5
              ...
              shadow-[0_8px_32px_rgba(47,125,246,.22)] cursor-pointer"
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ border: "1px solid rgba(47,125,246,.18)" }}
      />
      ...
      <div
        className="absolute inset-x-0 top-0 h-px"
        style={{
          background: "linear-gradient(90deg, transparent, rgba(47,125,246,.65), transparent)",
        }}
      />
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(47,125,246,.08) 0%, transparent 65%)" }}
      />
      <div
        className="absolute -right-24 top-1/2 -translate-y-1/2 w-[420px] h-[420px] pointer-events-none"
        style={{ background: "radial-gradient(circle, rgba(25,85,216,.07) 0%, transparent 65%)" }}
      />
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-3 flex-shrink-0">
          <motion.a
            ...
            className="btn-primary flex items-center justify-center gap-2.5
              ...
              shadow-[0_8px_32px_rgba(47,125,246,.22)] whitespace-nowrap"
            whileHover={{ scale: 1.03, y: -2 }}
            whileTap={{ scale: 0.97 }}
          >
            Solicitar Presupuesto
...
export default function ContactSection() {
  ...
  return (
    <section
      ...
      style={{
        background: [
          "radial-gradient(ellipse 62% 55% at 18% 38%, rgba(47,125,246,.07) 0%, transparent 58%)",
          "radial-gradient(ellipse 55% 52% at 88% 28%, rgba(25,85,216,.07) 0%, transparent 55%)",
          "radial-gradient(ellipse 50% 50% at 50% 95%, rgba(47,125,246,.05) 0%, transparent 55%)",
          "#050B14",
        ].join(", "),
      }}
    >
