    ...
    >
      <div
        className="relative rounded-2xl overflow-hidden border border-white/[.08]
          shadow-[0_0_80px_rgba(47,125,246,.06)]"
        style={{
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
          <div className="w-[700px] h-56 rounded-full opacity-30" style={{
            background:
              "radial-gradient(ellipse, rgba(47,125,246,.09) 0%, rgba(25,85,216,.05) 45%, transparent 70%)",
          }} />
        </div>
...
export default function SystemsSection() {
  ...
  return (
    <section
      ...
      style={{
        background: [
          "radial-gradient(ellipse 62% 55% at 88% 18%, rgba(47,125,246,.07) 0%, transparent 58%)",
          "radial-gradient(ellipse 55% 50% at 8%  72%, rgba(25,85,216,.065) 0%, transparent 55%)",
          "#050B14",
        ].join(", "),
      }}
    >
