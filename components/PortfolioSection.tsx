...
function FitnessMockup() {
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none"
        style={{ background: "radial-gradient(ellipse at 60% 35%,rgba(47,125,246,.18) 0%,transparent 65%)" }}/>

      <svg viewBox="0 0 580 352" className="relative z-10 w-[90%]"
        style={{ filter: "drop-shadow(0 14px 40px rgba(47,125,246,.3))" }}>
        <defs>
          ...
          <linearGradient id="ft-btn" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#2F7DF6"/><stop offset="100%" stopColor="#1955D8"/>
          </linearGradient>
        </defs>

        {/* Lid */}
        <rect x="14" y="4" width="552" height="304" rx="12" fill="url(#ft-f)"/>
        <rect x="14" y="4" width="552" height="304" rx="12" fill="none" stroke="rgba(47,125,246,.1)" strokeWidth="1"/>
        ...
        <g clipPath="url(#ft-c)">
          ...
          <ellipse cx="370" cy="90" rx="220" ry="140" fill="rgba(47,125,246,.09)"/>
          <ellipse cx="170" cy="220" rx="160" ry="120" fill="rgba(25,85,216,.06)"/>

          {/* Navbar */}
          <rect x="32" y="18" width="516" height="28" fill="rgba(0,0,0,.5)"/>
          <rect x="48" y="24" width="14" height="14" rx="3"
            fill="rgba(47,125,246,0)" stroke="rgba(47,125,246,.6)" strokeWidth="1.2"/>
          ...
          {/* Badge */}
          <text x="42" y="64" fill="rgba(47,125,246,.6)" fontSize="6.5" letterSpacing="3"
          ...
          {([["50+","Clientes"],["100%","Satisfacción"],["3","Planes"]] as const).map(([n,l],i)=>(
            <g key={l}>
              <text x={90+i*150} y="180" textAnchor="middle" fill="rgba(47,125,246,.9)"
            ...
            return (
              <g key={f}>
                <rect x={x} y="216" width="148" height="60" rx="8"
                  fill="rgba(47,125,246,.05)" stroke="rgba(47,125,246,.14)" strokeWidth=".8"/>
                <rect x={x+10} y="226" width="20" height="18" rx="4" fill="rgba(47,125,246,.25)"/>
                ...
                <text x={x+74} y="268" textAnchor="middle" fill="rgba(47,125,246,.35)"
        ...
        <rect x="0" y="308" width="580" height="3" fill="rgba(47,125,246,.04)"/>
        <rect x="212" y="315" width="156" height="16" rx="3" fill="rgba(0,0,0,.3)"
          stroke="rgba(255,255,255,.045)" strokeWidth=".5"/>
        <rect x="0" y="332" width="580" height="10" rx="5" fill="#080e18"/>
        <ellipse cx="290" cy="348" rx="265" ry="6" fill="rgba(0,0,0,.4)"/>
        <ellipse cx="290" cy="348" rx="180" ry="4" fill="rgba(47,125,246,.1)"/>
      </svg>
    </div>
  );
}
