  ...
  return (
    <div className="relative flex-shrink-0 w-12 h-12">
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(47,125,246,.14) 0%, rgba(25,85,216,.08) 100%)",
          border: "1.5px solid rgba(47,125,246,.5)",
        }}
...
function StepCardContent({ step }: { step: StepData }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{
        y: -4,
        borderColor: "rgba(47,125,246,.28)",
        boxShadow:   "0 18px 55px rgba(47,125,246,.1)",
      ...
      <div className="flex flex-col items-center flex-shrink-0 z-10">
        ...
        {!isLast && (
          <motion.div
            ...
            style={{
              height:          "72px",
              background:      "linear-gradient(to bottom, rgba(47,125,246,.35), rgba(47,125,246,.05))",
              transformOrigin: "top",
            }}
            initial={{ scaleY: 0 }}
      ...
      <div className="flex flex-col items-center flex-shrink-0">
        ...
        {!isLast && (
          <motion.div
            ...
            style={{
              background:      "linear-gradient(to bottom, rgba(47,125,246,.28), rgba(47,125,246,.04))",
              transformOrigin: "top",
            }}
            initial={{ scaleY: 0 }}
            animate={inView ? { scaleY: 1 } : {}}
...
export default function ProcessSection() {
  ...
  return (
    <section
      ...
      style={{
        background: [
          "radial-gradient(ellipse 65% 55% at 50% 0%, rgba(47,125,246,.07) 0%, transparent 55%)",
          "radial-gradient(ellipse 55% 60% at 5%  60%, rgba(25,85,216,.065) 0%, transparent 55%)",
          "radial-gradient(ellipse 50% 55% at 95% 55%, rgba(47,125,246,.055) 0%, transparent 55%)",
          "#050B14",
        ].join(", "),
      }}
    >
        ...
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="proc-dots" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
              <circle cx="1" cy="1" r="1" fill="#2F7DF6" />
            </pattern>
          </defs>
